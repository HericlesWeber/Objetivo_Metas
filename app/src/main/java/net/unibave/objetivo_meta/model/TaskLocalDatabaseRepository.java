...
public class TaskLocalDatabaseRepository {
    ...
    public void create(final Task task) {
        ...
        contentValues.put(COLUMN_DATATAREFA, dateFormat.format(task.getDataTarefa()));
    ...
    public List<Task> findAll() {
        ...
        String[] fields = { COLUMN_ID, COLUMN_CREATED_AT, COLUMN_NAME, COLUMN_DONE , COLUMN_DATATAREFA };
        ...
        if (cursor != null && cursor.getCount() > 0) {
            ...
            do {
                ...
                Date datatarefa = new Date();
                try {
                    createdAt = dateFormat.parse(
                            cursor.getString(cursor.getColumnIndexOrThrow(COLUMN_CREATED_AT)));
                    datatarefa = dateFormat.parse(cursor.getString(cursor.getColumnIndexOrThrow(COLUMN_DATATAREFA)));
