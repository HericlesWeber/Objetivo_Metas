package net.unibave.objetivo_meta.view;
...
import net.unibave.objetivo_meta.R;
import net.unibave.objetivo_meta.controller.TaskController;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void createTask(String name, String dataTarefa) {
        new Thread(() -> {
            String message = "";
            try {
                taskController.create(name , dataTarefa);
    ...
    private void createTaskDialog() {
        ...
        EditText dialogTaskdataTarefa = view.findViewById(R.id.taskdataTarefa);
        dialogTaskdataTarefa.addTextChangedListener(Mask.insert("##/##/####" , dialogTaskdataTarefa));
        builder
            .setView(view)
            .setPositiveButton(getString(R.string.button_add), (dialog, which) -> {
                String taskName = dialogTaskName.getText().toString();
                String taskdataTarefa = dialogTaskdataTarefa.getText().toString();
                createTask(taskName, taskdataTarefa);
            })
    ...
    public void editTaskDialog(Task task) {
        ...
        dialogTaskdataTarefa.setText(sdf.format(task.getDataTarefa()));
        builder
                .setView(view)
                ...
                .setPositiveButton(getString(R.string.button_save), (dialog, which) -> {
                    ...
                    try {
                        task.setDataTarefa(sdf.parse(dialogTaskdataTarefa.getText().toString()));
